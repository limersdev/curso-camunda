...
@Component
@ExternalTaskSubscription("exaustor")
public class Handler implements ExternalTaskHandler {
    ...
    public void execute(ExternalTask externalTask, ExternalTaskService externalTaskService) {
        ...
        variaveis.put("operacao_exaustor", resultadoUmidade.get("operacao_exaustor"));

        logger.info("Operando exaustor {}", entries(variaveis));
