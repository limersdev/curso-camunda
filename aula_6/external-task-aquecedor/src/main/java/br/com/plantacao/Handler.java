...
@Component
@ExternalTaskSubscription("aquecedor")
public class Handler implements ExternalTaskHandler {
    ...
    public void execute(ExternalTask externalTask, ExternalTaskService externalTaskService) {
        ...
        variaveis.put("operacao_aquecedor", resultadoTemperatura.get("operacao_aquecedor"));

        logger.info("Operando aquecedor {}", entries(variaveis));
